...
class CandidateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Partylists ───────────────────────────────────────────────
        $sinagtala = $resolve(Partylist::class, 'name', 'SINAGTALA');
        ...
        $candidates = [
            ...
            // ══════════════════════════════════
            //  COLLEGE OF EDUCATION (COE) — SINAGTALA / SBO
            // ══════════════════════════════════

            ['first_name' => 'Carl Ian',             'last_name' => 'Dahao',      'middle_name' => 'Fernandez', 'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $secondYearRep,  'college_id' => $coe, 'course' => 'COE',          'photo' => '1775910954_2ND YEAR REPRESENTATIVE, CARL IAN DAHAO.JPG'],
            ['first_name' => 'Michael',              'last_name' => 'Tinoy',      'middle_name' => 'Ticar',     'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $thirdYearRep,   'college_id' => $coe, 'course' => 'COE',          'photo' => '1775911008_3RD YEAR REPRESENTATIVE, MICHAEL TINOY.JPG'],
            ['first_name' => 'Rheanna Maryen',       'last_name' => 'Tandog',     'middle_name' => 'Gabales',   'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $assocSecretary, 'college_id' => $coe, 'course' => 'COE',          'photo' => '1775911197_ASSOCIATE SECRETARY, RHEANNA MARYEN TANDOG.JPG'],
            ['first_name' => 'Joshua',               'last_name' => 'Gawangan',   'middle_name' => null,        'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $auditor,        'college_id' => $coe, 'course' => 'COE',          'photo' => '1775911236_AUDITOR, JOSHUA GAWANGAN.JPG'],
            ['first_name' => 'Roan',                 'last_name' => 'Lanzaderas', 'middle_name' => null,        'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $governor,       'college_id' => $coe, 'course' => 'BSED-MATH',    'photo' => '1775911399_GOVERNOR, ROAN LANZADERAS.JPG'],
            ['first_name' => 'Ella',                 'last_name' => 'Nobesis',    'middle_name' => null,        'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $pro,            'college_id' => $coe, 'course' => 'BEED',         'photo' => '1775911604_PUBLIC RELATIONS OFFICER, ELLA  NOBESIS.JPG'],
            ['first_name' => 'Golemeer',             'last_name' => 'Rambuyon',   'middle_name' => 'Quilinguin','partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $treasurer,      'college_id' => $coe, 'course' => 'BSED-MATH',    'photo' => '1775912981_TREASURER, GOLEMEER RAMBUYON.JPG'],
            ['first_name' => 'Nashrea',              'last_name' => 'Dumagpi',    'middle_name' => 'Meliston',  'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $viceGovernor,   'college_id' => $coe, 'course' => 'BSED-SOCSTUD', 'photo' => '1775913062_VICE GOVERNOR, NASHREA DUMAGPI.JPG'],
            ['first_name' => 'Corrine May',          'last_name' => 'Molina',     'middle_name' => null,        'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $fourthYearRep,  'college_id' => $coe, 'course' => 'BECED',        'photo' => '1775913635_4TH YEAR REPRESENTATIVE, CORRINE MAY MOLINA.JPG'],
            ['first_name' => 'Patrick Charles',      'last_name' => 'Melendez',   'middle_name' => 'Casulla',   'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $assocTreasurer, 'college_id' => $coe, 'course' => 'BSED-ENG',     'photo' => '1775913682_ASSOCIATE TREASURER, PATRICK CHARLES MELENDEZ.JPG'],
            ['first_name' => 'Jade Ross',            'last_name' => 'Montañez',   'middle_name' => 'Ruiz',      'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $secretary,      'college_id' => $coe, 'course' => 'BEED',         'photo' => '1775913733_SECRETARY, JADE ROSS MONTAÑEZ.JPG'],
            ...
            // ══════════════════════════════════
            //  COLLEGE OF ARTS & SCIENCES (CAS) — SINAGTALA / SBO
            // ══════════════════════════════════

            ['first_name' => 'Hazel Faith',          'last_name' => 'Lantong',    'middle_name' => 'Allosada',  'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $secondYearRep,  'college_id' => $cas, 'course' => 'BS-BIO',       'photo' => '1775917368_2ND YEAR REPRESENTATIVE, HAZEL FAITH LANTONG.JPG'],
            ['first_name' => 'Irish Jane',           'last_name' => 'Lofranco',   'middle_name' => 'Palingcod', 'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $thirdYearRep,   'college_id' => $cas, 'course' => 'AB-ECON',      'photo' => '1775917404_3RD YEAR REPRESENTATIVE, IRISH JANE LOFRANCO_.JPG'],
            ['first_name' => 'Margalo Clarrise',     'last_name' => 'Fernandez',  'middle_name' => 'Jagunos',   'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $fourthYearRep,  'college_id' => $cas, 'course' => 'AB-ECON',      'photo' => '1775917436_4TH YEAR REPRESENTATIVE, MARGALO FERNANDEZ.JPG'],
            ['first_name' => 'Coleen',               'last_name' => 'Vestidas',   'middle_name' => 'Cañete',    'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $secretary,      'college_id' => $cas, 'course' => 'AB-SOCIO',     'photo' => '1775917492_ASSOCIATE SECRETARY, COLEEN VESTIDAS.JPG'],
            ['first_name' => 'Kennan Jemm',          'last_name' => 'Tejero',     'middle_name' => 'Gomez',     'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $assocTreasurer, 'college_id' => $cas, 'course' => 'BS-BIO',       'photo' => '1775917530_ASSOCIATE TREASURER, KENNAN JEMM TEJERO.JPG'],
            ['first_name' => 'Christopher',          'last_name' => 'Dumaque',    'middle_name' => 'Fernandez', 'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $auditor,        'college_id' => $cas, 'course' => 'AB-PHILO',     'photo' => '1775917555_AUDITOR, CHRISTOPHER DUMAQUE_.JPG'],
            ['first_name' => 'Camilo Jr.',           'last_name' => 'Anaya',      'middle_name' => 'Abella',    'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $governor,       'college_id' => $cas, 'course' => 'AB-PHILO',     'photo' => '1775917597_GOVERNOR, CAMILO ANAYA.JPG'],
            ['first_name' => 'Jayvee',               'last_name' => 'Okinlay',    'middle_name' => 'Baculbacul','partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $pro,            'college_id' => $cas, 'course' => 'BS-BIO',       'photo' => '1775917625_PUBLIC RELATIONS OFFICER, JAYVEE OKINLAY.JPG'],
            ['first_name' => 'Aliah Faye',           'last_name' => 'Badajos',    'middle_name' => 'Sario',     'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $secretary,      'college_id' => $cas, 'course' => 'AB-ENG',       'photo' => '1775917651_SECRETARY, ALIAH FAYE BADAJOS.JPG'],
            ['first_name' => 'Justine Mark',         'last_name' => 'Longcob',    'middle_name' => 'Lagat',     'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $treasurer,      'college_id' => $cas, 'course' => 'BS-MATH',      'photo' => '1775917683_TREASURER, JUSTINE MARK LONGCOB.JPG'],
            ['first_name' => 'Billy Joel',           'last_name' => 'Briones',    'middle_name' => 'Caingcoy',  'partylist_id' => $sinagtala, 'organization_id' => $sbo, 'position_id' => $viceGovernor,   'college_id' => $cas, 'course' => 'AB-ENG',       'photo' => '1775917712_VICE GOVERNOR, BILLY JOEL BRIONES.JPG'],
