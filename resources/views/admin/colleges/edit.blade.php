<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-xl text-gray-800 dark:text-gray-100 leading-tight">Edit College</h2>
                <p class="text-sm text-violet-600 dark:text-violet-400 mt-0.5">Updating: <strong>{{ $college->name }}</strong></p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-2xl mx-auto">
        <form method="POST" action="{{ route('admin.colleges.update', $college) }}" class="space-y-5">
            @csrf @method('PUT')
            ...
            <div class="bg-white dark:bg-violet-950/40 rounded-2xl border border-violet-100 dark:border-violet-800/50 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $college->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="acronym" value="{{ old('acronym', $college->acronym) }}"
                               placeholder="e.g., COE"
