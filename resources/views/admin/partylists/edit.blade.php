...
<div class="apl-wrap">
    <div class="apl-page-header">
        ...
        <div>
            <div class="apl-page-title">Edit Partylist</div>
            <div class="apl-page-sub">Updating: <strong>{{ $partylist->name }}</strong></div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.partylists.update', $partylist) }}">
        @csrf @method('PUT')
        <div class="apl-card">
            ...
            <div class="apl-card-body">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" class="apl-textarea"
                              placeholder="Enter partylist description (optional)…">{{ old('description', $partylist->description) }}</textarea>
