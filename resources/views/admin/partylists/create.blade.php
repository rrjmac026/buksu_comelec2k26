<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-xl text-gray-800 dark:text-gray-100 leading-tight">Add New Partylist</h2>
                <p class="text-sm text-violet-600 dark:text-violet-400 mt-0.5">Create a new partylist</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-2xl mx-auto">
        <form method="POST" action="{{ route('admin.partylists.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="bg-white dark:bg-violet-950/40 rounded-2xl border border-violet-100 dark:border-violet-800/50 shadow-sm p-6">
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-floppy-disk text-xs"></i> Create Partylist
                    </button>
                </div>
            </div>
        </form>
