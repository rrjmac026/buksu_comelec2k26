<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-xl text-gray-800 dark:text-gray-100 leading-tight">Add New Position</h2>
                <p class="text-sm text-violet-600 dark:text-violet-400 mt-0.5">Create a new election position</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
                            Position Name <span class="text-rose-500">*</span>
                        </label>
                    ...
                    <p class="text-xs text-violet-500 dark:text-violet-400 flex items-center gap-1">
                        <i class="fas fa-info-circle"></i> Position name must be unique
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-violet-950/40 rounded-2xl border border-violet-100 dark:border-violet-800/50 shadow-sm p-6">
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-floppy-disk text-xs"></i> Create Position
                    </button>
                </div>
            </div>
        </form>
