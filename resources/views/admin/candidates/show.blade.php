...
<div class="ac-grid">
    ...
    <div>
        ...
        {{-- Ballot Secrecy Notice (replaces Recent Votes table) --}}
        <div class="ac-card" style="animation-delay:.14s;">
            <div class="ac-table-head">
                <i class="fas fa-lock" style="color:rgba(249,180,15,0.6);font-size:0.75rem;"></i>
                <span class="ac-table-head-title">
                    ...
                    <span style="font-family:'DM Sans',sans-serif;font-size:0.7rem;font-weight:400;color:rgba(255,251,240,0.35);margin-left:6px;">
                        ({{ $candidate->votes()->count() }} total)
                    </span>
                </span>
            </div>
            <div style="padding: 28px 24px; display: flex; align-items: flex-start; gap: 16px;">
                <div style="width:44px;height:44px;border-radius:13px;flex-shrink:0;
                            ...
                            display:flex;align-items:center;justify-content:center;font-size:1rem;color:#f9b40f;">
                    <i class="fas fa-lock"></i>
                </div>
                <div>
                    <p style="font-size:0.78rem;font-weight:700;color:rgba(249,180,15,0.85);margin:0 0 6px;">
                        Ballot Secrecy Protected
                    </p>
                    <p style="font-size:0.72rem;color:rgba(255,251,240,0.45);line-height:1.75;margin:0;">
                        Individual voter identities are not disclosed to protect ballot secrecy
                        and maintain the integrity of the election process. Only the aggregate
                        vote count is available to administrators.
                    </p>
                </div>
            </div>
        </div>
