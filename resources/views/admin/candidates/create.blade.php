<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="font-bold text-xl text-gray-800 dark:text-gray-100 leading-tight">Add New Candidate</h2>
                <p class="text-sm text-violet-600 dark:text-violet-400 mt-0.5">Create a new candidate entry</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <div>
                        ...
                        <textarea name="platform" rows="4"
                                  ...
                                  class="w-full px-4 py-2.5 rounded-xl text-sm
                                         ...
                                         text-gray-800 dark:text-gray-200
                                         focus:outline-none focus:ring-2 focus:ring-violet-400
                                         placeholder-violet-300 dark:placeholder-violet-600">{{ old('platform') }}</textarea>
                    </div>
            ...
            <div class="bg-white dark:bg-violet-950/40 rounded-2xl border border-violet-100 dark:border-violet-800/50 shadow-sm p-6">
                <div class="flex items-center gap-3">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-floppy-disk text-xs"></i> Create Candidate
                    </button>
                </div>
            </div>
        </form>
