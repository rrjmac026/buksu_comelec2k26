                    ...
                    <div>
                        ...
                        <select name="college_id"
                            ...
                            @foreach($colleges as $college)
                                <option value="{{ $college->college_id }}" {{ old('college_id', $candidate->college_id) == $college->college_id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="partylist_id"
                            ...
                            @foreach($partylists as $partylist)
                                <option value="{{ $partylist->partylist_id }}" {{ old('partylist_id', $candidate->partylist_id) == $partylist->partylist_id ? 'selected' : '' }}>
                                    {{ $partylist->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="organization_id"
                            ...
                            @foreach($organizations as $organization)
                                <option value="{{ $organization->organization_id }}" {{ old('organization_id', $candidate->organization_id) == $organization->organization_id ? 'selected' : '' }}>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="position_id"
                            ...
                            @foreach($positions as $position)
                                <option value="{{ $position->position_id }}" {{ old('position_id', $candidate->position_id) == $position->position_id ? 'selected' : '' }}>
                                    {{ $position->name }}
                                </option>
                            @endforeach
                        </select>
